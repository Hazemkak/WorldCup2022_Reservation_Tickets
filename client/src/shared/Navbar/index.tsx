...
const navItems = [
  ...
  },
  {
    ...
    isShownWhenLoggedOut: false,
    isShownWhenLoggedIn:
      true && getLoggedInUser()?.role === "0" && getLoggedInUser()?.isVerified,
  },
  {
    ...
    isShownWhenLoggedOut: false,
    isShownWhenLoggedIn:
      true && getLoggedInUser()?.role === "2" && getLoggedInUser()?.isVerified,
  },
  {
    ...
    isShownWhenLoggedOut: false,
    isShownWhenLoggedIn:
      true && getLoggedInUser()?.role === "1" && getLoggedInUser()?.isVerified,
  },
];
